<template>
  <section>
    <content-divider :width="'2px'" :maxLength="'90%'" :align="'center'" :margin="'1rem'" />
    <div class="settings">
      ...
      <router-link :to="'/workspace/' + workspace.id + '/settings'">Paramètres de l'espace de travail</router-link>
    </div>
    <content-divider :width="'2px'" :maxLength="'90%'" :align="'center'" :margin="'1rem'" />
    <div class="change">
      ...
      <router-link to="/">Changer d'espace de travail</router-link>
    </div>
  </section>
</template>
